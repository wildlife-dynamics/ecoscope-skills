...
- **Override paths** must match group titles exactly — mismatches are silently ignored
  (`rjsf.md`). **`ecoscope:task_group` flips** break submit, and mock tests cannot catch it
  (`rjsf.md` § Never flip).
